...
<div class="navbar navbar-default navbar-fixed-top" role="navigation">
 <div class="container">
  ...
  <div id="footer">
        ...
        <div class="container">
          <p class="text-muted">
          <div style="display:none">Designed & Developed by Sulton Nazarov
  </div>
          <!-- FOOTER -->
        <footer>
          <p class="pull-right">
  ...
  <a href="#"  class="twtr">Twitter</a>
          ...
          <p>&copy; 202 Company, Inc. &middot;
           <!-- <a href="#">About Us</a>  &middot;  <a href="#">Contact Us</a> &middot; <a href="#">Privacy</a> -->
            <!-- &middot; <a href="#">Terms</a> &middot; <a href="#">Sitemap</a> -->
             </p>
        </footer>
          </p>
        </div>
